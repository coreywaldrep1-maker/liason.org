...
// - Works whether your route calls: applyI129fMapping(saved, form)
//   or mapI129F(form, saved) or defaultExport(...).
// - Safe setters (no crashes on missing fields).
// - Includes new sections: Beneficiary-in-US, IMB/relationship, criminal,
//   interpreter/preparer, and biographic info.
// - Alias arrays let you add your exact PDF field IDs from Excel.
//
// If any field is still blank, open your PDF debug overlay,
// copy the actual field name, and add it to that field’s alias array below.
...
function coreApply(saved, form) {
  ...
  // Physical history (two slots in the form)
  ...
  // Advanced overrides: any "other.{PDF_FIELD_NAME}" typed in the wizard
  try {
...
// 4) CommonJS interop (if some server code still uses require)
try {
  // eslint-disable-next-line no-undef
  if (typeof module !== 'undefined') {
    // eslint-disable-next-line no-undef
    module.exports = {
      applyI129fMapping: _defaultExport,
      mapI129F: _defaultExport,
      mapI129f: _defaultExport,
