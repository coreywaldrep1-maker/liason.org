...
// Full I-129F mapper (Parts 1–8) with defensive exports & arg order.
// Works whether the route calls: applyI129fMapping(saved, form) OR mapI129F(form, saved) OR default(...).
// Safe reads (no .toLowerCase() on objects), tolerant setters, alias arrays, and “other overrides”.
...
function coreApply(saved, form) {
  ...
  // Beneficiary in U.S. & travel docs
  setYesNo(form, ['Pt2Line38_InUS_Yes','Beneficiary_Currently_In_US_Yes_Checkbox_page7_38'],
                ['Pt2Line38_InUS_No','Beneficiary_Currently_In_US_No_Checkbox_page7_38'], ben.inUS);
  ...
  // “Other overrides”: any raw PDF field by exact name
  try {
...
export function mapI129F(a,b){ const isForm=(x)=>x&&typeof x.getTextField==='function'&&typeof x.getCheckBox==='function'; const [saved,form]=isForm(a)?[b,a]:[a,b]; coreApply(saved,form);}
export const mapI129f = mapI129F;
const _defaultExport = function(a,b){ const isForm=(x)=>x&&typeof x.getTextField==='function'&&typeof x.getCheckBox==='function'; const [saved,form]=isForm(a)?[b,a]:[a,b]; coreApply(saved,form); };
